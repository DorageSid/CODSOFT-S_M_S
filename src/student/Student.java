...
public class Student {
    ...
    public void insert(int id, String sname, String date, String gender,
        ...
        try {
            ...
            if (ps.executeUpdate() > 0) {
                JOptionPane.showMessageDialog(null, "new student added succcesfully!");
    ...
    public void delete(int id) {
        int yesOrNo = JOptionPane.showConfirmDialog(null, "courses and score record will also be deleted", "Student Delete", JOptionPane.OK_OPTION, 0);
